...
//****************************************************************************************************************************************************************************
exports.className = "Crud";
exports.args =      [ "attrs", "$modalcontainer", "$pageboxes", "pm", "notification" ];
exports.props =     [
  "CREATE_PENDING", "CREATE_OK", "CREATE_NOK", "CREATE_VALID_NOK", "READ_PENDING", "READ_OK", "READ_NOK",
  "crudObj", "entity", "$log", "status", "valid", "$icon", "buttons", "$buttons", "modalAttrs", "modalId", "modal", "notificationMap"
];
exports.methods =   { "send":send, "handleClickButton":handleClickButton, "handleClickIcon":handleClickIcon };
exports.init =      init;
